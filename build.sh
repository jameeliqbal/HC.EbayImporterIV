...
${nuget_cmd} install src/EBay.OAS3v1IV/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/EBay.OAS3v1IV.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/EBay.OAS3v1IV.dll \
-recurse:'src/EBay.OAS3v1IV/*.cs' \
-doc:bin/EBay.OAS3v1IV.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/EBay.OAS3v1IV.dll was created successfully"
fi
